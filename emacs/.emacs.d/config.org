...
#+end_src
*** Make Emacs Sound Like A Proper Typewriter.
...
When in a Dired buffer which is under git management, hit the 'close
parenthesis' key to show the git information.
...
One of the things that people know about Lisp is that it is heavily
dependent on the use of parentheses. To help working with the bracket
laden code, Paredit Mode allows you to slurp or barf items into and
out of a set of brackets. Details are available in the Clojure for the
